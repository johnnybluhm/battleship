...
//        undo_.push(game_.getBoard().copy());
...
//        game_.setBoard(undo_.pop()); // sets board in game_ to the last old board stored in undo_
//    }
//
...
//        game_.setBoard(redo_.pop()); // sets board in game_ to be the next most recent board stored in redo_
//    }
//}
